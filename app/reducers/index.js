...
// import updatelog_reducer from "./UpdateLogReducer";
import rating_reducer from "./RatingReducer";
import login_reducer from "./LoginReducer";
export default combineReducers({login_reducer, tab_reducer, home_reducer, profile_reducer, stuff_reducer, recipe_list_reducer, friend_list_reducer, search_reducer, top_recipe_reducer, new_recipe_reducer, timeline_reducer, recipe_log_reducer, rating_reducer});